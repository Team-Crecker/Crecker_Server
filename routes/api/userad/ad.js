...
router.get("/:progress", async (req, res) => {
    ...
    if (!selectUseradResult)
        ...
        res.status(200).send(defaultRes.successTrue(statusCode.OK, "유저 광고 조회 성공", selectUseradResult));    // 작품 삭제 성공
    
});

router.get("/:progress/:flag", async (req, res) => {
    let selectUseradQuery;
...
router.get("/:progress/:flag/:idx", async (req, res) => {
